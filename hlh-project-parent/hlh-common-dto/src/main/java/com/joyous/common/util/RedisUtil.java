...
//	}
//    private RedisUtil() {
//    	String server = getProperty("redis.server");
//    	String timeOut = getProperty("redis.timeout");
...
//			}
//    		    cluster= new JedisCluster(clusterNodes, StringUtils.isEmpty(timeOut)?  5000 : Integer.parseInt(timeOut));
//    	}
//	}
