...
//		if(redisUtil == null)redisUtil=RedisUtil.getInstance();
//	}
//
...
//		redisSwitch=getProperty("cache.redis.switch");
//		if(redisSwitch!=null && StringUtils.equals(redisSwitch, REDIS)){
//			initRedis();
//			return true;
//		}
//		return false;
...
//		}
//		try{
//			if(isUseRedis()&& !isForSession){
//				String setex = redisUtil.setexO(key, obj, seconds);
//				if(StringUtils.equals("OK", setex)){
//					return true;
//				}else{
//					return false;
//				}
...
//		try{
//			if(isUseRedis()&& !isForSession){
//				String setex = redisUtil.setexO(key, obj, (int)Math.ceil(new Double((exp.getTime() - new Date().getTime()))/ 1000));
//				if(StringUtils.equals("OK", setex)){
//					return true;
//				}else{
//					return false;
...
//		if(isUseRedis()){
//			 Object data = redisUtil.getO(key);
//			 if(data == null) {
//					memMap = new HashMap<String, String>();
//				} else {
//					memMap = (HashMap<String, String>) data;
//				}
//			 memMap.put(key, discript);
//			 redisUtil.setexO(key, memMap, 60*60*48);
//			 return true;
//		}
//
